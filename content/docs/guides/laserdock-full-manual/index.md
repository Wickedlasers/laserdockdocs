...
<img
src="Pictures/10000000000004F4000007029017E676.jpg"
style="width:16.503cm;height:23.349cm" />

<img
src="Pictures/10000000000004F400000702828DCDF7.jpg"
...
<img
src="Pictures/10000001000001B1000002B076B4CB4A.png"
style="width:4.949cm;height:7.867cm" /><img
src="Pictures/1000000100000178000002B3252F4301.png"
...
<img
src="Pictures/10000001000004F3000001A243958368.png"
...
<img
src="Pictures/1000000100000399000002F7049CBEAD.png"
...
src="Pictures/10000001000002BC0000017337C5089F.png"
style="width:12.947cm;height:6.862cm" />

# <span id="anchor-17"></span>MK2 Control Modes

The MK2 currently has 6 modes available to the user.
...
## <span id="anchor-18"></span>LaserOS Control Mode
...
supported third party applications like Liberation, or LaserShowGen etc.

In this mode all projections are streamed over LAN/WiFI directly to the
MK2 laser cube, so the Settings→Projection menu items will not be
available since these are now adjusted via the LaserOS settings menu, or
...
3)  If using WiFi server, connect to the Laser cube’s Access Point. By
    ...
    Laser2020. These may be changed under Settings, Network, WiFi
    Server.

<img
src="Pictures/10000000000000F000000140093C94D8.png"
style="width:3.334cm;height:4.445cm" /><img
src="Pictures/10000000000000F0000001409D4CA66C.png"
style="width:3.334cm;height:4.445cm" /><img
src="Pictures/10000000000000F000000140F4B55E87.png"
style="width:3.321cm;height:4.427cm" /><img
src="Pictures/10000000000000F000000140BAFD1B0E.png"
style="width:3.334cm;height:4.445cm" />

4)  If using LAN, we recommend using LAN Client. If no DHCP server is
    present on the network to assign an IP address, the Laser cube will
...
style="width:3.413cm;height:4.551cm" /><img
src="Pictures/10000000000000F000000140B71EF241.png"
...
Before you can add content to your MK2, or directly stream to it, our
LaserOS desktop software must firstly be installed onto your PC/Mac. Go
to <http://www.laseros.com/> and scroll down until you see the download
links as shown in the image below:

<img
src="Pictures/10000001000004E00000036122E30F7D.png"
...
#### <span id="anchor-20"></span>Windows Platform
...
<img
src="Pictures/100000000000017F000000EE3A344951.jpg"
...
<img
src="Pictures/100000000000022400000141865A7806.jpg"
...
<img
src="Pictures/10000001000002CD0000017B64D99980.png"
...
<img
src="Pictures/10000001000004620000028B1AACD4BA.png"
...
<img
src="Pictures/100000010000046000000286103F085E.png"
...
<img
src="Pictures/100000010000045F00000284D3824741.png"
...
### <span id="anchor-27"></span>Adding a custom SVG to the Playlist
...
<img
src="Pictures/100000010000045F000002868111205F.png"
...
<img
src="Pictures/100000010000045D00000280FB86CC44.png"
...
<img
src="Pictures/1000000100000443000003008894245F.png"
...
<img
src="Pictures/100000010000045F00000285D7EB338D.png"
...
<img
src="Pictures/100000010000045F0000028466006F7A.png"
...
export the entire playlist to the MK2.

You will need to insert the micro SD card provided with the MK2 into a
USB 3.x reader and then connect the reader to your PC/Mac.
...
<img
src="Pictures/100000010000045F00000285BCC87EC8.png"
...
<img
src="Pictures/10000001000004600000028BFBD43A10.png"
...
<img
src="Pictures/100000010000045B000002832AB914EE.png"
...
message box, then please ensure you have inserted the MK2 card into your
reader and into your PC properly, and also check that the volume name of
the SD card is shown as “WL”. If the SD card volume name is not “WL”
without the quotes then you can right click on the removable device and
rename the card to “WL” using Windows file manager. This should only be
necessary if you have used your own SD card and forgot to rename the
volume. The SD card should also contain a folder called “Lasercube”. If
it does not then you need to download the factory SD card image again
from our GitHub here: <https://github.com/Wickedlasers/mk2SDContent>

<img
src="Pictures/10000001000003A1000001D5DA72B162.png"
...
CUEs will be played on the MK2 (with shuffle mode disabled) is based on
the order of the entries in the “.ldpl” file.

*Note: Both the folder and playlist “.ldpl” file must be present for the
playlist to be available on the MK2. e.g. if either “Content 1.ldpl” or
“Content 1” folder are not present then “Content 1” will not be listed
in the playlists drop down on the MK2.*

### <span id="anchor-29"></span>Manual Customization of the Playlist File

The image below shows a small preview of the contents of another
playlist already provided on the factory supplied SD card for the MK2.
This is an extract of the Beams 1 playlist “.ldpl” JSON file viewed in a
text editor:

<img
src="Pictures/100000010000027B00000211DBABF6C6.png"
...
Note: The MK2 has this playlist and others as part of the demo SD card
provided with the device.

### <span id="anchor-30"></span>Using the new playlist on the MK2.
...
Place the SD card back into the MK2 and power on the cube. Select
...
<img
src="Pictures/10000000000002EA0000041E2108CC67.jpg"
...
cycle if the MK2 is in playlist control mode and “Power-On play” is
...
app, then the MK2 will no longer cycle through items in the playlist
...
Mapping](#16.MIDI Mapping using an APC40 MK II or APC Mini MK II|outline)
or the online wiki).

## <span id="anchor-33"></span>Playlist Player Web App

The playlist control mode includes a web server which can be used to
control the MK2 from your mobile or Laptop/PC device via a web browser
(tested with Safari / Mozilla Firefox).

You firstly need to connect to the MK2 using the chosen connection
method. If WiFi server is your chosen connection method (see
...
Once your device’s WiFi has connected to the MK2, go to your device web
browser (Firefox, Safari etc) and enter the IP address of the cube. This
is “192.168.4.1” by default, and can be checked in settings→network, or
just look at the LCD status bar for the IP address, as it is located in
the bottom right corner.

Example image of the playlist web app being served from the MK2 to
...
<img
src="Pictures/100000010000021F000002962DED4B42.png"
...
### <span id="anchor-35"></span>Playlist Web App Quick Player Settings
...
<img
src="Pictures/100000010000022000000295A33E4B33.png"
...
This menu allows you to quickly re-colour the projection from a pre-set
palette of colours.

The colour intensity (saturation / alpha) can also be adjusted using the
Intensity Slider.

<img
src="Pictures/1000000100000220000002955BB9CB3C.png"
style="width:7.59cm;height:9.222cm" />

Note: The projection re-colour effect will only work if you have enabled
effects in the MK2 Effects menu. The example image above is indicating
that the effects have not been enabled in the MK2 effects menu, so will
not operate until they are enabled.

### <span id="anchor-37"></span>Playlist Options Menu
...
power-on (immediately after interlock is enabled), or only after
activating the projection button in the playlist player or web app. The
default for power-on play is enabled, and any changes to this are
retained thru power cycle.
...
### <span id="anchor-40"></span>Multi-projector Laser Shows
...
#### <span id="anchor-41"></span>Example: Alive (2CH) Laser Show

Choose one Mk2 Laser cube to be the Master. This will be the one which
commands
...
stereo audio line input jack. The audio gain may also need to be
adjusted based on the volume of the external audio.
...
<img
src="Pictures/100000000000035D000001DA2259B609.jpg"
style="width:11.342cm;height:6.242cm" />

Spectrum2

<img
src="Pictures/10000000000002A800000295F3638FC4.jpg"
style="width:7.743cm;height:7.537cm" />

Voice

<img
src="Pictures/100000000000043C000001ED7AE37915.jpg"
style="width:12.233cm;height:5.556cm" />

The Visualizers can also have effects added to them, configured from the
Effects menu.

See the effects page here: [Effects](#14.MK2 Built in Effects|outline)
or the online wiki for more info on the built in effects, and also the
[tempo](#14.2.Mk2 Settings – Tempo|outline) menu which will affect the
speed of some BPM based effects.

<img
src="Pictures/10000000000000F0000001407F20D147.png"
style="width:4.048cm;height:5.398cm" /> <img
src="Pictures/10000000000000F00000014010677FDC.png"
style="width:4.048cm;height:5.398cm" />

Filter UI for a single effect, or All effects

<img
src="Pictures/10000000000000F0000001400F95A70E.png"
style="width:4.154cm;height:5.539cm" /> <img
src="Pictures/10000000000000F0000001404AA68E4D.png"
style="width:4.166cm;height:5.556cm" />

Color Cycle Effect

<img
src="Pictures/10000000000000F0000001405EC5A5CA.png"
style="width:4.339cm;height:5.786cm" /> <img
src="Pictures/10000000000000F000000140BF79E124.png"
style="width:4.339cm;height:5.786cm" />

Zoom Effect

<img
src="Pictures/10000000000000F000000140DA97991A.png"
style="width:4.339cm;height:5.786cm" /> <img
src="Pictures/10000000000000F000000140F2A692E3.png"
style="width:4.339cm;height:5.786cm" />

Hue Effect

<img
src="Pictures/10000000000000F0000001408225B272.png"
style="width:4.219cm;height:5.627cm" /> <img
src="Pictures/10000000000000F000000140D1F0817E.png"
style="width:4.219cm;height:5.627cm" />

Colorize Effect Flash Effect Strobe Effect

<img
src="Pictures/10000000000000F0000001401FBB4D16.png"
style="width:4.216cm;height:5.622cm" /><img
src="Pictures/10000000000000F0000001404818DEAE.png"
style="width:4.154cm;height:5.539cm" /><img
src="Pictures/10000000000000F000000140B0C599C8.png"
style="width:4.128cm;height:5.503cm" />

## <span id="anchor-43"></span>ArtNet Control Mode

### <span id="anchor-44"></span>Setting the control mode to ArtNet
...
#### <span id="anchor-46"></span>ArtNet Universe
...
the MK2. The default 16 channel map is available on the MK2 here: [DMX
Channel
...
support should also work with the MK2.

#### <span id="anchor-49"></span>CUE Selection
...
When the MK2 is connected to a valid ethernet network and ArtNet packets
are being received on the correct ArtNet Universe then the status bar
...
## <span id="anchor-52"></span>DMX Control Mode

### <span id="anchor-53"></span>Setting the control mode to DMX
...
A profile determines which DMX channels control what feature of the MK2.
The default 16 channel map is available here: [DMX Channel
...
#### <span id="anchor-57"></span>CUE Selection
...
When the MK2 is connected to DMX and receiving the 512 channels via the
...
### <span id="anchor-62"></span>DMX Channels NOT Implemented in the default fixture implementation
...
### <span id="anchor-63"></span>DMX/Art-Net Channel Layout
...
# <span id="anchor-65"></span>MK2 Settings

## <span id="anchor-66"></span>Mk2 Settings – Projection

> When in LaserOS control mode, the Image Setup, Color Balance and
...
<img
src="Pictures/10000000000000F000000140D818A2BA.png"
style="width:3.321cm;height:4.427cm" /> <img
src="Pictures/10000000000000F0000001405A9A625A.png"
style="width:3.307cm;height:4.41cm" /> <img
src="Pictures/10000000000000F0000001403475ED36.png"
...
<img
src="Pictures/10000000000000F00000014051735956.png"
...
<img
src="Pictures/10000000000000F0000001404EE66917.png"
style="width:3.401cm;height:4.533cm" /> <img
src="Pictures/10000000000000F000000140EED9CFB7.png"
style="width:3.413cm;height:4.551cm" /> <img
src="Pictures/10000000000000F000000140470661B3.png"
style="width:3.422cm;height:4.563cm" />
...
<img
src="Pictures/10000000000000F00000014030BCDA75.png"
style="width:3.637cm;height:4.851cm" /> ****<img
src="Pictures/10000000000000F000000140D7317285.png"
style="width:3.612cm;height:4.815cm" /> ****<img
src="Pictures/10000000000000F000000140FCFB2D8B.png"
style="width:3.581cm;height:4.775cm" /> ****

****<img
src="Pictures/10000000000000F00000014016743A27.png"
style="width:3.572cm;height:4.763cm" /> ****<img
src="Pictures/10000000000000F000000140C6CCE962.png"
...
<img
src="Pictures/1000000000000526000001B755B18CD7.jpg"
style="width:15.187cm;height:5.062cm" />

Keep Out Safety Zone

<img
src="Pictures/1000000000000525000001DC82110C19.jpg"
style="width:15.222cm;height:5.503cm" />

### <span id="anchor-73"></span>Test Patterns

<img
src="Pictures/10000000000000F000000140BE68634B.png"
style="width:3.798cm;height:5.062cm" /> <img
src="Pictures/10000000000000F0000001403BECC7E5.png"
...
applied to the projection (see MK2 effects wiki or in this guide here:
[Effects](#14.MK2 Built in Effects|outline)), e.g. The strobe effect
will flash faster as you increase the BPM slider in the tempo menu, and
flash slower when reducing the BPM slider.

The purpose of the tempo menu is mainly for live DJ effects while a
music track is playing.

In order for the supplied MK2 effects to work to the beat of a music
track you must first set the correct BPM, preferably using the tap BPM
feature, then use the sync button to mark which beat is the first beat
of a bar. Once this is done the MK2 effects will then be in sync with
any music that is playing allowing the user (with the aid of an APC40
MK2 MIDI controller) to perform live adjustments to the projection using
...
playing music track will allow the MK2 to calculate the actual BPM of
the music.
...
### <span id="anchor-76"></span>Audio Output Volume
...
audio connector on the rear of the MK2 labelled A-OUT (green connector)
...
orange), then long press again on the knob and a context menu will
appear allowing you to link this slider to a dial or fader over MIDI, or
unlink from an existing MIDI fader, or reset the slider to its default
value.
...
### <span id="anchor-77"></span>Audio Output Delay

This slider allows the audio output to be either delayed, or started
earlier (with respect to a projection like when using the MK2 in laser
show mode) in order to compensate for any audio processing delay due any
...
cause laser shows played on the MK2 to be completely out of sync with
the audio, so adjusting the out delay slider can compensate for this.

Note: Once a laser show on the MK2 has started, this slider will have no
affect on the audio output delay until you stop and start the laser show
again.

The audio settings also have no effect when using the MK2 in LaserOS
mode, as all audio is handled by LaserOS in this case.

### <span id="anchor-78"></span>Audio Input Selection
...
src="Pictures/10000000000000F0000001409C19DB74.bmp"
...
### <span id="anchor-79"></span>Max Line Gain / MAX MIC Gain
...
<img
src="Pictures/10000000000000F0000001405764E6E1.png"
style="width:4.057cm;height:5.41cm" /> <img
src="Pictures/10000000000000F0000001407A909C8A.png"
style="width:4.057cm;height:5.41cm" />

Select the connection type (required for control via LaserOS, ArtNet or
Liberation)

For multiple laser cubes and especially in areas where local WiFi may be
congested, we recommend using an Ethernet cable in LAN Client mode. When
set to LAN Client mode on a network without a DHCP server, the Laser
cubes will self-assign an APIPA address.

<img
src="Pictures/10000000000000F0000001408AA24156.png"
style="width:4.008cm;height:5.345cm" />

The tick by LAN-C indicates that the Mk2 Laser cube has connected in LAN
Client Mode.

The A-IP indicates that the IP address shown – 169.254.157.170 is an
AIPIPA one.
...
<img
src="Pictures/10000000000000F0000001404D455DC7.png"
style="width:3.863cm;height:5.151cm" /> <img
src="Pictures/10000000000000F000000140061687DE.png"
...
When using LAN client mode the MK2 laser cube will try to obtain an IP
...
to connecting a cable directly between PC/Mac/iOS and the MK2 laser
cube) then the MK2 will self assign itself an IP address using the Auto
IP protocol.
...
3.  Turn on your MK2 laser cube and connect an ethernet cable from the
    LAN port on the cube to the LAN port on your PC/macBook.
4.  Wait until the laser cube self assign’s an APIPA address.
5.  Start LaserOS on your macBook and check that the MK2 is detected
...
src="Pictures/10000000000000F000000140D818A2BA.png"
style="width:3.321cm;height:4.427cm" /> <img
src="Pictures/10000000000000F0000001402AE41C7A.png"
style="width:3.307cm;height:4.41cm" />

### <span id="anchor-84"></span><span id="anchor-85"></span><span id="anchor-86"></span>LAN Client Mode

For multiple laser cubes and especially in areas where local WiFi may be
congested, this is the recommended connection mode. When connected to a
network without a DHCP server, the Laser cubes will self-assign APIPA
addresses.

#### <span id="anchor-87"></span> LAN Client Mode Customisations
...
<img
src="Pictures/10000000000000F000000140A6F2D637.png"
style="width:3.348cm;height:4.463cm" /> <img
src="Pictures/10000000000000F00000014062E83824.png"
style="width:3.351cm;height:4.47cm" /> <img
src="Pictures/10000000000000F00000014035799B1B.png"
style="width:3.348cm;height:4.463cm" /> <img
src="Pictures/10000000000000F00000014076342E69.png"
...
<img
src="Pictures/10000000000000F00000014070E1086E.png"
style="width:3.348cm;height:4.463cm" /> <img
...
be far easier to implement, however it is retained for most flexibility.

#### <span id="anchor-89"></span> <span id="anchor-90"></span>LAN Server Mode Customisations

Manual configuration of IP Address and Net Mask

<img
src="Pictures/10000000000000F000000140045F0CD0.png"
...
#### <span id="anchor-93"></span> WiFi Server Mode Customisations

SSID, Password, Channel (including Auto), Bandwidth, IP Address, Net
Mask

<img
src="Pictures/10000000000000F0000001400A98068C.png"
style="width:3.307cm;height:4.41cm" /> <img
src="Pictures/10000000000000F000000140C81B5C7A.png"
style="width:3.293cm;height:4.392cm" /> <img
src="Pictures/10000000000000F00000014057171006.png"
style="width:3.298cm;height:4.397cm" />

<img
src="Pictures/10000000000000F000000140E4904C62.png"
...
#### <span id="anchor-95"></span>WiFi Client Mode Customisations

SSID, Password, IP Mode - Auto / Static (IP Address, Gateway, Net Mask)

<img
src="Pictures/10000000000000F0000001406671C9A9.png"
style="width:3.016cm;height:4.022cm" /> <img
src="Pictures/10000000000000F000000140599E2C16.png"
style="width:2.99cm;height:3.986cm" />

<img
src="Pictures/10000000000000F000000140990D5DCC.png"
style="width:3.254cm;height:4.339cm" /> <img
src="Pictures/10000000000000F000000140C6A3EA71.png"
style="width:3.254cm;height:4.339cm" /> <img
src="Pictures/10000000000000F000000140996CEBE9.png"
style="width:3.246cm;height:4.327cm" /> <img
src="Pictures/10000000000000F0000001400772B2B8.png"
...
Mk2 Laser cubes. Cube Link does not require a WiFI network to be present
as it creates its own wireless network to communicate between master and
...
In order to set up a Cube Link network, it must be enabled on each Mk2
Laser cube, then one Mk2 Laser cube must be set to Master, and the other
Mk2 Laser cubes as Slaves. To exist on the same Cube Link Network, they
must all share the same Link Channel and Link Pin. The Group determines
what content that particular Mk2 Laser cube will project. For a 2
projector Laser show, the first projector content will be shown on all
Mk2 Laser cubes set to Group 1 and the second projector content will be
shown on all Mk2 Laser cubes set to group 2.
...
<img
src="Pictures/10000000000000F0000001406EE4C13E.png"
...
<img
src="Pictures/10000000000000F0000001408A34D6F2.png"
style="width:3.293cm;height:4.392cm" /> <img
src="Pictures/10000000000000F00000014069617B4B.png"
style="width:3.263cm;height:4.352cm" /> <img
src="Pictures/10000000000000F000000140D1E60984.png"
style="width:3.246cm;height:4.327cm" />

<img
src="Pictures/10000000000000F00000014055370281.png"
style="width:3.56cm;height:4.745cm" /> <img
src="Pictures/10000000000000F0000001409B4CCD0F.png"
style="width:3.56cm;height:4.745cm" />
...
## <span id="anchor-98"></span>Mk2 Settings – USB MIDI
...
device will show the disconnected status as shown above. The status bar
will also show a green tick or a cross next to the MIDI label on the RHS
of the status bar.

## <span id="anchor-99"></span>Mk2 Settings – Playback Speed
...
## <span id="anchor-100"></span>Mk2 Settings – General

This menu has the option to change the LCD brightness and also an option
to enable backward compatibility with original WiFi cubes while using
LaserOS.

Note: The backward compatibility option will only need to be enabled if
you intend to use a mix of old WiFi cubes and new MK2 laser cubes on the
...
the MK2. With no ILDA cable connected, this item will be greyed out on
the MK2 menu UI.

<img
src="Pictures/10000000000000F0000001407DF9851A.png"
style="width:4.048cm;height:5.398cm" /> <img
src="Pictures/10000000000000F000000140100AD2C1.png"
style="width:4.048cm;height:5.398cm" />
...
<img
src="Pictures/10000000000000F000000140696B6717.png"
style="width:4.008cm;height:5.345cm" /> <img
src="Pictures/10000000000000F000000140599B8C82.png"
style="width:4.008cm;height:5.345cm" />

# <span id="anchor-102"></span>MK2 Built in Effects

The effects menu will be available on the top level menu of the MK2 when
it is in either playlist or visualizer control mode.

The effects can be used to modify the currently projected image, and
consist of both colour modifying effects and image movement / scale
effects.

These effects are also dependant on the current setting of the tempo
which can be accessed from settings→tempo or set using tap tempo an an
APC40 MK2 device (see wiki section on
[tempo](#14.2.Mk2 Settings – Tempo|outline)).
...
DEMO APC40 MK2 MIDI mapping on the SD card provided with the MK2).
...
More effects will be added in future firmware releases for the MK2,
allowing for more varied live projection modifications.

#### <span id="anchor-104"></span>Master Effect slider
...
#### <span id="anchor-105"></span>Effects Filter drop down

In order to access the required effect filter more quickly via the menu
UI, the user can use the effect filter drop down. By default the effect
filter is set to “ALL” so all filters can be accessed by scrolling
...
<img
src="Pictures/100000010000014400000112FAB7EC74.png"
style="width:2.819cm;height:2.383cm" />Blue → Green → Cyan → Red →
Magenta → Yellow

<img
src="Pictures/1000000100000145000001100760404E.png"
style="width:2.819cm;height:2.383cm" /><img
src="Pictures/100000010000014100000112F6AB42AE.png"
style="width:2.819cm;height:2.383cm" /><img
src="Pictures/100000010000014400000105727FD791.png"
style="width:2.819cm;height:2.383cm" /><img
src="Pictures/100000010000014500000114D89F73DA.png"
style="width:2.819cm;height:2.383cm" /><img
...
<img
src="Pictures/1000000100000145000001035A2DF249.png"
style="width:5.854cm;height:4.665cm" /><img
src="Pictures/10000001000001440000010303DD7723.png"
...
#### <span id="anchor-108"></span>Default APC40 MK2 Colour Cycle Effect MIDI mapping
...
<img
src="Pictures/10000001000003FC0000027E5464D862.png"
...
on the current tempo (see [tempo](#14.2.Mk2 Settings – Tempo|outline) in
the wiki).

#### <span id="anchor-110"></span>Zoom effect parameters
...
#### <span id="anchor-111"></span>Default APC40 MK2 Zoom Effect MIDI mapping
...
#### <span id="anchor-113"></span>Hue effect parameters
...
<img
src="Pictures/10000001000001410000002F68B1AB08.png"
...
<img
src="Pictures/100000010000047F000002CA9961B92D.png"
style="width:17cm;height:10.545cm" />
...
#### <span id="anchor-117"></span>Default APC40 MK2 Colourize Effect MIDI mapping
...
<img
src="Pictures/100000010000047F000002CA9C863F35.png"
style="width:17cm;height:10.545cm" />
...
#### <span id="anchor-120"></span>Default APC40 MK2 Flash Effect MIDI mapping
...
current tempo (see wiki for [tempo](#14.2.Mk2 Settings – Tempo|outline)
menu).
...
#### <span id="anchor-123"></span>Default APC40 MK2 Strobe Effect MIDI mapping
...
<img
src="Pictures/100000010000047F000002CA831C4284.png"
style="width:17cm;height:10.545cm" />
...
<img
src="Pictures/10000000000000F0000001406FBAC429.png"
style="width:3.651cm;height:4.868cm" /> <img
src="Pictures/10000000000000F000000140BD86AA68.png"
style="width:3.667cm;height:4.891cm" />

<img
src="Pictures/10000000000000F00000014096C77EA5.png"
style="width:3.625cm;height:4.833cm" /> <img
src="Pictures/10000000000000F00000014087A2819E.png"
style="width:3.634cm;height:4.845cm" /> <img
src="Pictures/10000000000000F000000140312215D0.png"
style="width:3.651cm;height:4.868cm" /> <img
src="Pictures/10000000000000F000000140F908991A.png"
...
The Ultra MK2 is capable of being controlled directly using an APC 40
MK2 or an APC mini MK2 (others will be added TBD.) connected to the USB
...
### <span id="anchor-128"></span>Enabling USB MIDI
...
### <span id="anchor-129"></span>MIDI Mapping a Slider Control
...
Almost all sliders in the MK2’s menu UI can be assigned to an external
APC Dial or Fader.

Note: Faders on an APC40 are absolute controls and will always override
the MK2 slider value when moved, unlike APC dials which are relative
adjustment control with no physical end stops.

Once a slider from the MK2’s menu UI has been assigned to an APC
...
control will now also move the slider on the MK2 menu.
...
<img
src="Pictures/1000000000000300000004001B84800D.jpg"
style="width:6.502cm;height:8.67cm" />

Note: When an APC dial is un-linked from a MK2 UI element, the LED ring
will go off.

### <span id="anchor-130"></span>Un-mapping a Slider Control

To remove a previous MIDI mapping from a slider in the MK2 menu UI, edit
the control by short press on the slider to enter edit mode, then long
...
### <span id="anchor-131"></span>MIDI Mapping a Button Control or Switch

Buttons and Switch elements in the menu UI can also be mapped to an APC
button by highlighting the element on the MK2 menu UI, and then long
...
<img
src="Pictures/1000000000000400000003005306EF8D.jpg"
...
The Laser cube has a legacy Web Admin Page for adjusting some of the MK2
network based configuration settings and also performing remote firmware
updates.
...
<img
src="Pictures/10000000000003620000036DD608080D.jpg"
...
<img
src="Pictures/10000000000003400000035CF6EE9CD3.jpg"
...
<img
src="Pictures/10000000000003500000020A32B4D081.jpg"
...
<img
src="Pictures/1000000000000345000001D9BEE39301.jpg"
...
## <span id="anchor-144"></span>Firmware Update
...
# <span id="anchor-146"></span>SD Card Information

The Ultra MK2 laser cube is supplied with a pre-loaded micro SD card
containing all demo laser shows, Playlists, and MIDI mappings for APC40
MK2 and APC mini MK2.

If you need additional SD cards then these can be obtained from places
like Amazon.

The card which we have tested and guarantee to work with the MK2 is the
Lexar A2 Silver Plus 64Gb micro SD card
(<https://americas.lexar.com/product/lexar-professional-silver-plus-microsdxc-uhs-i-card/>).

The MK2 supports this range of cards up to 2Tb.
...
<img
src="Pictures/1000000100000449000002EE84CC2053.png"
